...
namespace Quest.Lib.Suggestions
{
    ...
    public class ARDCommon
    {
        ...
        /// <returns></returns>
        public static IOrderedEnumerable<CandidateResource> GetBestAppropriateResources(IRouteEngine router, int hour, int easting, int northing, String resourceType, double distanceMax, double durationMax, int category, List<ResourceView> Resources, int instanceMax, double enrouteFactor, double waitingFactor)
        {
