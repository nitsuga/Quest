...
namespace Quest.Lib.Routing.Speeds
{
    ...
    public class SpeedDataHoD : SpeedDataMatrix
    {
        ...
        private void LoadSpeedDataHoD(float overrideSpeedMph = 25)
        {
        ...
        /// <param name="hourOfDay">0-23 hour of the day</param>
        /// <returns>the eastimated speed in MPH</returns>
        public float GetRoadSpeedMphHoD(int roadType, Coordinate coordBng, int vehicleType, int hourOfDay)
        {
            ...
            var speed = Data[(int) x, (int) y, vehicleType, roadType, hourOfDay];
            return speed;
        }
