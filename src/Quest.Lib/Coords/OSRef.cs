...
namespace Quest.Lib.Coords
{
    ...
    ///     </p>
    /// </summary>
    public class OSRef : CoordinateSystem, ICloneable
    {
        /**
     ...
     */
        ...
        public object Clone()
        {
            return new OSRef(Easting = Easting, Northing = Northing);
        }
        ...
        /// </summary>
        /// <returns>
        ///     A string representing this OSGB grid reference in ten-figure
        ///     notation
        /// </returns>
        public string ToTenFigureString()
        {
            var e = (int) Math.Floor(easting - 100000*HundredKmEast());
            var n = (int) Math.Floor(northing - 100000*HundredKmNorth());
        ...
        /// </summary>
        /// <returns>
        ///     A string representing this OSGB grid reference in six-figure
        ///     notation
        /// </returns>
        public string ToSixFigureString()
        {
            var e = (int) Math.Floor((easting - 100000*HundredKmEast())/100);
            var n = (int) Math.Floor((northing - 100000*HundredKmNorth())/100);
