...
/// <summary>
/// [DllImport("csta32.dll")] for windows
/// [DllImport("csta32.dll")]
/// </summary>
namespace Quest.Lib.Telephony.Avaya
{

    public sealed class Csta
    {
        private Csta()
        {
        }
        ...
        {
            // null
            public event nullEventHandler @null;
        ...
        public const int CF_CALL_CLEARED = 32768;
        public const int CF_CONFERENCED = 16384;
        public const int CF_CONNECTION_CLEARED = 8192;
        public const int CF_DELIVERED = 4096;
        public const int CF_DIVERTED = 2048;
        public const int CF_ESTABLISHED = 1024;
        public const int CF_FAILED = 512;
        public const int CF_HELD = 256;
        public const int CF_NETWORK_REACHED = 128;
        public const int CF_ORIGINATED = 64;
        public const int CF_QUEUED = 32;
        public const int CF_RETRIEVED = 16;
        public const int CF_SERVICE_INITIATED = 8;
        public const int CF_TRANSFERRED = 4;
        public const int FF_CALL_INFORMATION = 128;
        public const int FF_DO_NOT_DISTURB = 64;
        public const int FF_FORWARDING = 32;
        public const int FF_MESSAGE_WAITING = 16;
        public const int AF_LOGGED_ON = 128;
        public const int AF_LOGGED_OFF = 64;
        public const int AF_NOT_READY = 32;
        public const int AF_READY = 16;
        public const int AF_WORK_NOT_READY = 8;
        public const int AF_WORK_READY = 4;
        public const int MF_BACK_IN_SERVICE = 128;
        public const int MF_OUT_OF_SERVICE = 64;
        [StructLayout(LayoutKind.Sequential, Pack = 4)]
        ...
        public const int DC_VOICE = 128;
        public const int DC_DATA = 64;
        public const int DC_IMAGE = 32;

        public const int DC_OTHER = 16;
        [StructLayout(LayoutKind.Sequential, Pack = 4)]
        ...
        public const int SF_INITIALIZING = 128;
        public const int SF_ENABLED = 64;
        public const int SF_NORMAL = 32;
        public const int SF_MESSAGES_LOST = 16;
        public const int SF_DISABLED = 8;
        public const int SF_OVERLOAD_IMMINENT = 4;
        public const int SF_OVERLOAD_REACHED = 2;

        public const int SF_OVERLOAD_RELIEVED = 1;
        [StructLayout(LayoutKind.Sequential, Pack = 4)]
        ...
        public const int TSERV_SAP_CSTA = 1369;
        public const int CLIENT_SAP_CSTA = 22789;
        public const int TSERV_SAP_NMSRV = 1371;
        public const int CLIENT_SAP_NMSRV = 23301;
        ...
        [DllImport("csta32.dll")]
        public static extern int acsOpenStream(ref UInt32 acsHandle, int invokeIDType, UInt32 invokeID, int streamType, char[] serverID, char[] loginID, char[] passwd, char[] applicationName, int acsLevelReq, char[] apiVer,
        ushort sendQSize, ushort sendExtraBufs, ushort recvQSize, ushort recvExtraBufs, ref PrivateData_t priv);
        ...
        [DllImport("csta32.dll")]
        public static extern int acsEventNotify(UInt32 acsHandle, IntPtr hwnd, int msg, bool notifyAll);
        ...
        [DllImport("csta32.dll")]
        public static extern int cstaHoldCall(UInt32 acsHandle, UInt32 invokeID, ref ConnectionID_t activeCall, bool reservation, ref PrivateData_t privateData);
        ...
        [DllImport("csta32.dll")]
        public static extern int cstaSetMsgWaitingInd(UInt32 acsHandle, UInt32 invokeID, char[] device, bool messages, ref PrivateData_t privateData);

        [DllImport("csta32.dll")]
        public static extern int cstaSetDoNotDisturb(UInt32 acsHandle, UInt32 invokeID, char[] device, bool doNotDisturb, ref PrivateData_t privateData);

        [DllImport("csta32.dll")]
        public static extern int cstaSetForwarding(UInt32 acsHandle, UInt32 invokeID, char[] device, ForwardingType_t forwardingType, bool forwardingOn, char[] forwardingDestination, ref PrivateData_t privateData);
        ...
        [DllImport("csta32.dll")]
        public static extern int cstaRouteSelect(UInt32 acsHandle, int routeRegisterReqID, int routingCrossRefID, char[] routeSelected, short remainRetry, ref SetUpValues_t setupInformation, bool routeUsedReq, ref PrivateData_t privateData);
        ...
        [DllImport("csta32.dll")]
        public static extern int cstaRouteSelectInv(UInt32 acsHandle, UInt32 invokeID, int routeRegisterReqID, int routingCrossRefID, ref DeviceID_t routeSelected, short remainRetry, ref SetUpValues_t setupInformation, bool routeUsedReq, ref PrivateData_t privateData);
